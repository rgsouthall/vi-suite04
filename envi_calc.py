...
#            er.zonereslist = zonereslist
    ...
    if len(zonelist) > 0:
        ...
        bpy.types.Scene.envi_reszoney1 = bpy.types.Scene.envi_reszoney2 = bpy.types.Scene.envi_reszoney3 = bpy.types.Scene.envi_reszone = eprop(zonelist, "Zone results", "Zone results identifier", zonelist[-1][0])
        bpy.types.Scene.envi_ytype1 = eprop([("0", "Climate", "Plot a climate parameter on the x-axis"), ("1", "Zone", "Plot a zone result on the x-axis")], "Y-axis 1", "specify the EnVi results display", "0")
        bpy.types.Scene.envi_ytype2 = eprop([("0", "None", "Plot a climate parameter on the y-axis"), ("1", "Climate", "Plot a climate parameter on the x-axis"), ("2", "Zone", "Plot a zone result on the x-axis")],
                                                        "Y-axis 2","specify the EnVi results display", "0")
        bpy.types.Scene.envi_ytype3 = eprop([("0", "None", "Plot a climate parameter on the x-axis"), ("1", "Climate", "Plot a climate parameter on the x-axis"), ("2", "Zone", "Plot a zone result on the x-axis")],
                                                        "Y-axis 3", "specify the EnVi results display","0")
        bpy.types.Scene.envi_resparamy1 = bpy.types.Scene.envi_resparamy2 = bpy.types.Scene.envi_resparamy3 = bpy.types.Scene.envi_resparam = eprop(zonereslist, "Zone results", "Zone results identifier", zonereslist[0][0])
    else:
        bpy.types.Scene.envi_ytype1 = EnumProperty(items = [("0", "Climate", "Plot a climate parameter on the x-axis")],
                                                        name="Y-axis 1",
                                                        description="specify the EnVi results display",
                                                        default="0")
        bpy.types.Scene.envi_ytype2 = EnumProperty(items = [("0", "None", "Plot a climate parameter on the x-axis"), ("1", "Climate", "Plot a climate parameter on the x-axis")],
                                                        name="Y-axis 2",
                                                        description="specify the EnVi results display",
                                                        default="0")
        bpy.types.Scene.envi_ytype3 = EnumProperty(items = [("0", "None", "Plot a climate parameter on the x-axis"), ("1", "Climate", "Plot a climate parameter on the x-axis")],
                                                        name="Y-axis 3",
                                                        description="specify the EnVi results display",
                                                        default="0")
    [reslist.append((filename.split(".")[0], filename.split(".")[0], 'Results File')) for filename in glob.glob("*.eso")]

    bpy.types.Scene.envi_resfiles = EnumProperty(
            items = reslist, name="Results file", description="Name of the results file", default=node.resname)
    try:
        bpy.types.Scene.envi_resclimy1 = EnumProperty(items = climlist, name="Climate results", description="Climate results type", default=climlist[0][0])
        bpy.types.Scene.envi_resclimy2 = bpy.types.Scene.envi_resclimy3 = bpy.types.Scene.envi_resclim = EnumProperty(items = climlist, name="Climate results", description="Climate results type", default=climlist[0][0])
    except:
    ...
    bpy.types.Scene.envi_display_start_month = iprop("Month", "Month of the year", 1, 12, dos[2][0])
    bpy.types.Scene.envi_display_start_day = iprop("Day", "Day of the month", 1, 31, dos[3][0])
    bpy.types.Scene.envi_display_start_day30 = iprop("Day", "Day of the month",1, 30, dos[3][0])
    bpy.types.Scene.envi_display_start_day28 = iprop("Day", "Day of the month", 1, 28, dos[3][0])
    bpy.types.Scene.envi_display_start_hour = iprop("Hour", "Hour of the day", 1, 24, dos[4][0])
    bpy.types.Scene.envi_display_end_month = iprop("Month", "Month of the year", 1, 12, dos[2][-1])
    bpy.types.Scene.envi_display_end_day = iprop("Day", "Day of the year", 1, 31, dos[3][-1])
    bpy.types.Scene.envi_display_end_day30 = iprop("Day", "Day of the year", 1, 30, dos[3][-1])
    bpy.types.Scene.envi_display_end_day28 = iprop("Day", "Day of the year", 1, 28, dos[3][-1])
    bpy.types.Scene.envi_display_end_hour = iprop("Hour", "Hour of the day", 1, 24, dos[4][-1])
